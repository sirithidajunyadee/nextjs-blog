  ...
  return (
    <React.Fragment>
      ...
      <main>
        ...
        <div align="center"><img src={`/images/p.png`} width="1000" alt="" title=''/></div>
                ...
                <Card className={classes.card}>
                  ...
                  <CardContent className={classes.cardContent}>
                    <Typography gutterBottom variant="h5" component="h2">
                      ติดต่อ SK ชาวเล มหาชัย
                    </Typography>
                    <Typography>
                      โทร. 087-455-5558, 093-289-1455
                      <br/>อีเมล์ : skfrozenseafoodd@gmail.com
                      <br/>Line ID : @335rxyyu
                      <br/>ที่ตั้งสำนักงาน : ตลาดทะเลไทย ม.1 1/2 ถ.พระราม 2 ต.ท่าจีน อ.เมือง จ.สมุทรสาคร 74000
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
