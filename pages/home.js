    ...
    <React.Fragment>
      ...
      <AppBar position="relative">
        { <Toolbar>
          ...
          ขายส่งอาหารทะเล ทุกชนิด ทั้งของสดและแช่แข็ง จัดส่งทั่วประเทศ  &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;&emsp; &emsp;
           &emsp; ติดต่อเราโทร. 093-289-1455, 087-455-5558
          </Typography>
      ...
      <main>
          ...
          <Container maxWidth="sm">
            ...
            <div className={classes.heroButtons}>
              <Grid container spacing={2} justifyContent="center">
                ...
                <Grid item>
                  <a href='about_us'><Button variant="outlined" color="primary">
                    เกี่ยวกับเรา
                  </Button>
                  </a>
                </Grid>
                ...
                <Grid item>
                <a href='contact'><Button variant="outlined" color="primary">
                    ติดต่อเรา
                  </Button>
                  </a>
                </Grid>
        ...
        <div align="center"><img src={`/images/prok.png`} width="1000"  alt="" title=''/></div>
        <Typography component="h1" variant="h3" align="center" color="textPrimary" gutterBottom>
        อาหารทะเลสด สดๆจากทะเล
            </Typography>
            <Typography variant="h5" align="center" color="textSecondary" paragraph>
            อาหารทะเลสด/แช่แข็ง ทุกชนิด สั่งซื้อสินค้าได้ตลอด 24 ชั่วโมง
            ...
            {cards.map((card) => (
              <Grid item key={card} xs={12} sm={6} md={4}>
                <Card className={classes.card}>
                  ...
                  <CardActions>
                  <a href='product'><Button size="small" color="primary">
                      View
                    </Button></a>
                  </CardActions>
                </Card>
